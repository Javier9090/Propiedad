...
class PropiedadController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('propiedad_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Propiedad $entity)
    {
        $form = $this->createForm(new PropiedadType(), $entity, array(
            'action' => $this->generateUrl('propiedad_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new PropiedadType(), $entity, array(
            'action' => $this->generateUrl('propiedad_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('propiedad_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('propiedad'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('propiedad_delete', array('id' => $id)))
            ->setMethod('DELETE')
