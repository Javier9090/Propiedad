...
class TipoPropiedadController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('propiedades_TipoPropiedad_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(TipoPropiedad $entity)
    {
        $form = $this->createForm(new TipoPropiedadType(), $entity, array(
            'action' => $this->generateUrl('propiedades_TipoPropiedad_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new TipoPropiedadType(), $entity, array(
            'action' => $this->generateUrl('propiedades_TipoPropiedad_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('propiedades_TipoPropiedad_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('propiedades_TipoPropiedad'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('propiedades_TipoPropiedad_delete', array('id' => $id)))
            ->setMethod('DELETE')
