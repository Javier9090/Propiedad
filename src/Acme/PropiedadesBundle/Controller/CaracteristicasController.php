...
class CaracteristicasController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('caracteristicas_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Caracteristicas $entity)
    {
        $form = $this->createForm(new CaracteristicasType(), $entity, array(
            'action' => $this->generateUrl('caracteristicas_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new CaracteristicasType(), $entity, array(
            'action' => $this->generateUrl('caracteristicas_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('caracteristicas_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('caracteristicas'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('caracteristicas_delete', array('id' => $id)))
            ->setMethod('DELETE')
